                        ...
                        <div className="p-8 ">
                            <form onSubmit={handleReTransfer} className="blur-0">
                                ...
                                <div className="modal_payout blur-0  ">
                                    ...
                                    <input onChange={(e) => setSendAmount(e.target.value)} value={sendAmount} style={{ caretColor: `${isDarkMode ? "#fff" : "#000"}` }} required placeholder='Сумма' type="text" className={`${isDarkMode ? "text-white" : ""} blur-0 mb-2 bg-transparent border placeholder:text-[14px] border-[#6C6E86] w-full py-[10px] px-4 outline-none rounded-[4px]`} />
