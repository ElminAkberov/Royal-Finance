    ...
    return (
        <div>
            <div className="pagination-buttons bg-transparent flex items-center my-4">
                ...
                <button className={`text-[#2D54DD] no-click`} onClick={() => setCurrentPage(currentPage > 1 ? currentPage - 1 : currentPage)}>
                    <FaAngleLeft />
                </button>
                ...
                <button className={`text-[#2D54DD] no-click`} onClick={() => setCurrentPage(totalPages > currentPage ? currentPage + 1 : currentPage)}>
                    <FaAngleRight />
                </button>
            </div>
        </div>
