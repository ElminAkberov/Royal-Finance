                    ...
                    <div className={`${isDarkMode ? "bg-[#1F1F1F] " : "bg-[#F5F6FC] border-[#F4F4F5] border"}  min-h-[100vh] h-full z-20  relative `}>
                        ...
                        <div className={` `}>
                            <div className="">
                                ...
                                <div className="py-[12px] group cursor-pointer px-[8px] min-h-[48px] flex items-center rounded-[4px] mx-[12px] ">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <NavLink to={"/ad"} className="py-[12px] group cursor-pointer px-[8px] flex items-center rounded-[4px] mx-[12px] min-h-[48px] bg-[#2D54DD4D]">
                                    ...
                                    <p className={`w-max group-hover:opacity-100 opacity-0 group-hover:visible invisible duration-300 absolute left-12 p-2 shadow-xl rounded-md bg-[#fff] text-[#2D54DD] text-[14px]  font-medium ml-[8px]   whitespace-nowrap`}>Объявления</p>
                                </NavLink>
                            </div>
                        </div>
                    </div>
